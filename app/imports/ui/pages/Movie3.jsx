...
import Movie3Comp from '../components/Movie3Comp';
...
class Movie3 extends React.Component {
  ...
  renderPage() {
    return (
        ...
        <Container>
          <Header as="h1" textAlign="center">The Vast of Night</Header>
          <Grid>
              <GridRow centered>
          ...
          <Table celled>
            ...
            <Table.Body>
              {this.props.ratings.map((rating) => <Movie3Comp key={rating._id} currentRating={rating} />)}
            </Table.Body>
          </Table>
        </Container>
    );
...
export default withTracker(() => {
  ...
  const movieName = 'The Vast of Night';
  return {
