...
import Movie4Comp from '../components/Movie4Comp';
...
class Movie4 extends React.Component {
  ...
  renderPage() {
    return (
        ...
        <Container>
          <Header as="h1" textAlign="center">Judy Punch</Header>
          ...
          <Table celled>
            ...
            <Table.Body>
              {this.props.ratings.map((rating) => <Movie4Comp key={rating._id} currentRating={rating} />)}
            </Table.Body>
          </Table>
        </Container>
    );
